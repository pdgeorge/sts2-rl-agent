"""Does a community card-quality prior in the deckbuilder pay? Prediction 14.
...
def main() -> int:
    ...
    ap.add_argument("--out", default="output/ab_card_prior.rows.jsonl")
    args = ap.parse_args()
    ...
    print(f"\nPAIRED over {len(shared)} shared seeds (prior vs none):")
