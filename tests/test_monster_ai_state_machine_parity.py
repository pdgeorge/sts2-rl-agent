...
BYGONE_EFFIGY_SLASH_DAMAGE_A9 = 15  # GetValueIfAscension(DeadlyEnemies, 15, 13)
...
INFESTED_PRISM_WHIRLWIND_DAMAGE_A9 = 6  # GetValueIfAscension(DeadlyEnemies, 6, 5)
...
class TestFixedRotation:
    ...
    def test_axebot_moves_use_original_player_targets_with_osty_redirect(self):
        ...
        ally_hp = 70
        osty_hp = 40
        one_two_damage = 9  # GetValueIfAscension(DeadlyEnemies, 10, 9)
        one_two_hits = 2
        hammer_uppercut_damage = 12  # GetValueIfAscension(DeadlyEnemies, 14, 12)
    ...
    def test_act4_normal_haunted_ship_living_fog_and_two_tailed_rat_match_original_moves(self):
        ...
        bomb_combat.add_enemy(bomb, bomb_ai)
        assert bomb.max_hp == 7  # GasBomb.MinInitialHp: GetValueIfAscension(ToughEnemies, 8, 7)
